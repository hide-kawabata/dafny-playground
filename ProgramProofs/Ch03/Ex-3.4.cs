// Dafny program Ex-3.4.dfy compiled into C#
...
// Command Line Options: Ex-3.4.dfy
// Ex-3.4.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger J(BigInteger x, BigInteger y)
    {
    TAIL_CALL_START: ;
      if ((x).Sign == 0) {
        return y;
        ...
        BigInteger _in1 = new BigInteger(3);
        x = _in0;
        y = _in1;
        goto TAIL_CALL_START;
      } else {
        BigInteger _in2 = x;
        BigInteger _in3 = (y) - (BigInteger.One);
        x = _in2;
        y = _in3;
        goto TAIL_CALL_START;
      }
