// Dafny program Ex-3.12.dfy compiled into C#
...
// Command Line Options: Ex-3.12.dfy
// Ex-3.12.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static void Study(BigInteger n, BigInteger h)
    {
    TAIL_CALL_START: ;
      if ((h).Sign != 0) {
        BigInteger _in0 = n;
        BigInteger _in1 = (h) - (BigInteger.One);
        n = _in0;
        h = _in1;
        ...
        BigInteger _0_hours;
        BigInteger _out0;
        _out0 = __default.RequiredStudyTime((n) - (BigInteger.One));
        _0_hours = _out0;
        BigInteger _in2 = (n) - (BigInteger.One);
        BigInteger _in3 = _0_hours;
        n = _in2;
        h = _in3;
        goto TAIL_CALL_START;
      }
    }
    public static BigInteger RequiredStudyTime(BigInteger c)
    {
      BigInteger hours = BigInteger.Zero;
      hours = new BigInteger(200);
      return hours;
    }
  }
